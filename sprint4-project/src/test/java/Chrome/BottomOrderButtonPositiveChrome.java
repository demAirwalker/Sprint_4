...
public class BottomOrderButtonPositiveChrome {
    ...
    public BottomOrderButtonPositiveChrome(String name, String surname, String address, String metro, String phoneNumber,
